...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        ...
        payload = {"email": "test@example.com", "password": "pw", "name": "Test usr"}
        res = self.client.post(CREATE_USER_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_create_token_bad_credentials(self):
        ...
        payload = {"email": "test@example.com", "password": "testpass1"}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_refresh_token_gives_new_access(self):
        """Test generates a new token when refresh is provided"""
        user_details = {
            "name": "Test Name",
            "email": "test@example.com",
            "password": "test-user-pass123",
